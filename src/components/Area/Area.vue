  ...
  <div>
    <div class="area_titleCascader">
      <div class="area_title_text">
        <!-- <img src="../../../static/image/header/policeBadge.png" class="policeBadge"/> -->
    ...
    [
      ...
      },
      {
        ...
        sub: [{name: "请选择", sub: []},
          ...
          {
            name: "淮安",
            sub: [{name: "请选择"}, {name: "淮阴区"}, {name: "清江浦区"}, {name: "淮安区", available:  true }, {name: "洪泽区"}, {name: "开发区"}, {name: "涟水县"}, {name: "盱眙县"}, {name: "金湖县"}],
            type: 0,
            available:  true
          },
          {
  ...
  export  default {
    ...
    methods:{
      ...
      updateCity: function (city) {
        ...
        this.city = city|| this.cityArr[1].name;
      },
      updateDistrict: function (district) {
        ...
        if(district) return this.district =  district;
